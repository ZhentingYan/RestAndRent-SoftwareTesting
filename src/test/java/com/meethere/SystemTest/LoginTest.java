...
public class LoginTest extends BaseTest {
  ...
  @Order(1)
  @Test
  public void test_RR_ST_TC_001_002_4() throws InterruptedException {
  ...
  @Order(2)
  @Test
  public void test_RR_ST_TC_001_001_1() {
    driver.get("http://localhost:8888/index");
    assertThat(driver.getTitle(), is("主页-Rest&Rent"));
    driver.findElement(By.linkText("登录")).click();
    assertThat(driver.getTitle(), is("登录-Rest&Rent"));
  ...
  @Order(3)
  @Test
  public void test_RR_ST_TC_001_002_1() {
    driver.get("http://localhost:8888/index");
    assertThat(driver.getTitle(), is("主页-Rest&Rent"));
    driver.findElement(By.linkText("登录")).click();
    assertThat(driver.getTitle(), is("登录-Rest&Rent"));
  ...
  @Order(4)
  @Test
  public void test_RR_ST_TC_001_001_2() {
    driver.get("http://localhost:8888/index");
    assertThat(driver.getTitle(), is("主页-Rest&Rent"));
    driver.findElement(By.linkText("登录")).click();
    assertThat(driver.getTitle(), is("登录-Rest&Rent"));
  ...
  @Order(5)
  @Test
  public void test_RR_ST_TC_001_002_2() {
    driver.get("http://localhost:8888/index");
    assertThat(driver.getTitle(), is("主页-Rest&Rent"));
    driver.findElement(By.linkText("登录")).click();
    assertThat(driver.getTitle(), is("登录-Rest&Rent"));
  ...
  @Order(6)
  @Test
  public void test_RR_ST_TC_001_002_3() throws InterruptedException {
    driver.get("http://localhost:8888/index");
    assertThat(driver.getTitle(), is("主页-Rest&Rent"));
    driver.findElement(By.linkText("登录")).click();
    assertThat(driver.getTitle(), is("登录-Rest&Rent"));
    ...
    driver.findElement(By.id("submit")).click();
    Thread.sleep(500);
    assertThat(driver.getTitle(), is("Rest&Rent-管理系统"));
    driver.close();
  }
}
